...
Room::Room(string& new_desc, string& new_extended_desc, string& new_name, int& new_room_id, vector<Door
           > new_doors):mDesc{new_desc}, mExtendedDesc{new_extended_desc}, mName{new_name}, mRoomId{static_cast<unsigned int>(new_room_id)}, doors{new_doors}{
}
