...
Combatant::Combatant(networking::Connection connection_,Character* character_, std::string name_, bool npcFlag_)
:connection{connection_},character{character_}, name{name_}, npcFlag{npcFlag_}{}
